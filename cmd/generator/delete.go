...
// deleteCmd represents the delete generator set command
var deleteCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err := generator.Delete(name, locationID, projectID, agentName, force); err != nil {
...
func init() {
	generatorCmd.AddCommand(deleteCmd)
	...
	deleteCmd.Flags().StringP("force", "f", "", "Forces to delete the generator and its references. Possible values: true or false (optional)")
